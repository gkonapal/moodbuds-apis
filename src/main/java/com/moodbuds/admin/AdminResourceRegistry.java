...
public class AdminResourceRegistry {
    ...
    public AdminResourceRegistry() {
        ...
        register(new ResourceDefinition("products", "products", Set.of("sku","name","slug","category_id","subcategory_id","gst_rate_id","description","fabric_details","color_name","price","discount_price","weight_grams","length_cm","width_cm","height_cm","is_featured","is_new_arrival","is_best_seller","return_window_days","is_active"), "name", true, true, true));
