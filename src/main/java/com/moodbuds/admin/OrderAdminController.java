...
public class OrderAdminController {
 ...
 private final JdbcClient jdbc;private final AuditService audit;public OrderAdminController(JdbcClient jdbc,AuditService audit){this.jdbc=jdbc;this.audit=audit;}
